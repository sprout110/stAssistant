(function (v, w) {
    if ("object" === typeof exports && "undefined" !== typeof module)
        ...
        "function" === typeof define && define.amd ? define(w) : v.ES6Promise = w()
    }
})(this,
    function () {
        function v(a) {
        ...
        function R() {
            return "undefined" !== typeof B ? function () { B(n) } : C()
        }
        function S() {
            var a = 0,
                b = new J(n),
        ...
        function X(a, b) {
            b._state === y ?
                ...
                b._state === t ?
                    g(a, b._result) :
                    E(b, void 0, function (b) { return x(a, b) }, function (b) { return g(a, b) })
        }
        function N(a, b, c) {
        ...
        var H = void 0,
            ...
            B = void 0,
            I = void 0,
            l = function (a, b) { q[k] = a; q[k + 1] = b; k += 2; 2 === k && (I ? I(n) : Q()) },
            ...
            z = (new Date()).getTime().toString(36), //Math.random().toString(36).substring(2),
            ...
            ba = function () {
                    ...
                    P(c) ?
                        (
                            ...
                            0 === this.length ?
                                ...
                                (
                                    this.length = this.length || 0, this._enumerate(c),
                ...
                a.prototype._eachEntry = function (a, c) {
                    var d = this._instanceConstructor,
                        e = d.resolve;
                    e === F ?
                        (e = M(a), e === D && a._state !== u ?
                            this._settledAt(a._state, c, a._result) :
                            "function" !== typeof e ?
                                (this._remaining-- , this._result[c] = a) :
                                d === h ?
                                    (d = new d(r), N(d, a, e), this._willSettleAt(d, c)) :
                                    this._willSettleAt(new d(function (c) { return c(a) }), c)) : this._willSettleAt(e(a), c)
                };

                a.prototype._settledAt = function (a, c, d) {
                    var e = this.promise; e._state === u && (this._remaining-- , a === t ? g(e, d) : this._result[c] = d); 0 === this._remaining && m(e, this._result)
                };

                a.prototype._willSettleAt = function (a, c) {
                    var d = this; E(a, void 0, function (a) {
                        return d._settledAt(y, c, a)
                    },
                        function (a) { return d._settledAt(t, c, a) })
                };
        ...
        h.polyfill = function () {
            var a = void 0;
            if ("undefined" !== typeof global) a = global; else if ("undefined" !== typeof self) a = self; else try { a = Function("return this")() } catch (b) { throw Error("polyfill failed because global object is unavailable in this environment"); } var c = a.Promise; if (c) {
