...
def CandleV30(stockId='2412', 
    ...
    stockData = StockDataModel(stockId=stockId)
    ...
    if not df.empty and len(df)>3:
        ...
        for buyDate in Buy(stockId = stockId):
        ...
        for sellDate in Sell(stockId = stockId):
        ...
        title = f'\n{stockId}-{stockData.GetStockName()}'
        ...
        mc = mpf.make_marketcolors(up='r', down='lime', edge="black")
        apds = []
